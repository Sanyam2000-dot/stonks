...
function calculate() {
    ...
    if (!isNaN(costPrice) && !isNaN(quantity) && !isNaN(sellingPrice)) {
        ...
        output.innerHTML = "Please enter all the required values";
    }
}